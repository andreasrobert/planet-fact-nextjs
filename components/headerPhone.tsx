...
function HeaderPhone(props:{setRocket:(arg: string)=>void,rocket:string}) {  
    ...
    <>
      <Container>
          ...
          <HamburgerImgContainer onClick={handleClick}>
            <Image src={require("../public/assets/icon-hamburger.svg")} alt="" layout="responsive" />
            </HamburgerImgContainer>

      </Container>
      <MenuContain className={`${showMenu}`}>
          <Menu onClick={()=>{props.setRocket("MERCURY");handleClick()}}>
              <Contain>
            ...
            <SourceImgContainer>
            <Image src={require("../public/assets/icon-chevron.svg")} alt="" layout="responsive" />
            </SourceImgContainer>

          </Menu>

          <Menu onClick={()=>{props.setRocket("VENUS");handleClick()}}>
              <Contain>
          ...
          <Menu onClick={()=>{props.setRocket("EARTH");handleClick()}}>
              <Contain>
          ...
          <Menu onClick={()=>{props.setRocket("MARS");handleClick()}}>
              <Contain>
          ...
          <Menu onClick={()=>{props.setRocket("JUPITER");handleClick()}}>
              <Contain>
          ...
          <Menu onClick={()=>{props.setRocket("SATURN");handleClick()}}>
              <Contain>
          ...
          <Menu onClick={()=>{props.setRocket("URANUS");handleClick()}}>
              <Contain>
          ...
          <Menu onClick={()=>{props.setRocket("NEPTUNE");handleClick()}}>
              <Contain>
